...
header.innerHTML = '搜索: "'+ searchQuery + '" 的结果';

var searchResultsDiv = document.getElementById("searchResults");

var otherPages = ['中文1.html', '中文3.html', '中文4.html', '中文5.html', '中文6.html', '中文7.html', '中文8.html', '中文9.html'];
var pageNames = ['主页', '新闻', '政治', '手机，平板电脑，和电脑', '计算器'];
var pageDescriptions = ['这个网页没有描述', '这个网页没有描述', '这个网页没有描述', '这个网页没有描述', '这个网页没有描述'];
